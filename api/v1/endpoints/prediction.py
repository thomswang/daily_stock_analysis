...
职责：
- 横截面选股打分 / 主动推荐（rank、recommendations、industries、weekly）
- 走势预测模型的 walk-forward 回测（backtest）

预测回测与选股推荐共用 src/services 下的共享特征 / 训练能力；
旧版「单票走势预测 / 历史复盘」闭环已移除。
"""
...
from src.services.prediction_service import PredictionError, rank_stocks
